...
class Zookeeper(db.Model):
    ...
    animals=db.relationship('Animal',backref='zookeepers',lazy=True)
...
class Enclosure(db.Model):
    ...
    animals=db.relationship('Animal',backref='enclosures',lazy=True)

    def __repr__(self):
        return f"<Enclosure ID: {self.id}, Environment: {self.environment}, Open to Visitors: {self.open_to_visitors}>"
